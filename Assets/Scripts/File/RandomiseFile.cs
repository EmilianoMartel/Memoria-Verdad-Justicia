...
public class RandomiseFile : MonoBehaviour
{
    ...
    private void GenerateFiles()
    {
        ...
        if (_dataList.names[randomIndexName].gender == "male")
        {
            temp.background = _dataList.stories[randomStorie].male;
        }
        else
        {
            temp.background = _dataList.stories[randomStorie].female;
        }
